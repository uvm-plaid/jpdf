...
and/or MACed share distributions as in SPDZ \cite{evans2018pragmatic,10.1007/978-3-030-68869-1_3}.
We will also assume that any possible initial secrets are equally
likely when formulating the program distribution.  We define
...
\begin{definition}[Passive Security]
  ...
  simulation $\SIM$ such that:\todo{is the order of quantifiers right? Doesn't a single simulator have to work for all inputs?}
  $$
