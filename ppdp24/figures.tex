\newcommand{\compfig}
{
  \begin{fpfig}[t]{Comparison of systems for verification of MPC security in PLs.}{fig-comp}
    \begin{tabular}{lccccccc}
      ...
      $\lambda_{\text{obliv}}$ \cite{XXX} & \checkmark & & \checkmark & & & \checkmark & \checkmark \\\hline
      PSL \cite{XXX} & \checkmark & & \checkmark & & & & \\\hline
      Lilac \cite{XXX} & \checkmark & \checkmark & & & & & \\\hline
      Wys$^*$ \cite{XXX} & & & & \checkmark & & \checkmark & \checkmark\\\hline
      Viaduct \cite{XXX} & & & & \checkmark & \checkmark & \checkmark & \checkmark\\\hline
      MPC in EasyCrypt \cite{XXX} &  \checkmark &  \checkmark &  \checkmark & \checkmark & \checkmark & \checkmark & \\\hline
...
\newcommand{\solvefig}
{
  \begin{fpfig}[h]{Filtering solutions to expressions in $\mathbb{F}_2$.}{fig-solve}
