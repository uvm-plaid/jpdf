  ...
  \begin{fpfig}[t]{$\metaprot$ syntax (T), evaluation contexts (M), and operational semantics (B).}{fig-metaprot}
    ...
    $$
      \begin{array}{c}
        ...
        \begin{array}{l}
          ...
          \elet{y}{E}{e} \mid f(\mv,\ldots,\mv,E,e,\ldots,e) \mid \\
    ...
    \begin{mathpar}
      ...
      \inferrule
          ...
          {\config{\prog}{f(v_1,...,v_n)} \redx \config{\prog}{e[v_1/x_1,\ldots,v_n/x_n]}} 
      
      \config{\prog}{\{\ldots; \flab = v; \ldots\}.\flab} \redx \config{\prog}{v}
