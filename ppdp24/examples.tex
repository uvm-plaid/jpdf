...
\begin{lemma}
  ...
  such that
  \begin{mathpar}
    %\store(\elab{\secret{x}}{1}) = \elab{\mesg{x}}{1} + \elab{\mesg{x}}{2}
    %
    \store(\elab{\secret{y}}{2}) = \cod{\store, \elab{\mesg{y}}{1} + \elab{\mesg{y}}{2}}

    \store(\out{1}) = \cod{\store, \elab{\mesg{xy}}{1} + \elab{\mesg{xy}}{2}}
  \end{mathpar}
  we have:
  $$
