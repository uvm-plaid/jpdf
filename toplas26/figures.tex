...
\begin{array}{rcl@{\hspace{4mm}}r}
  ...
  \assign{e}{e} \mid f(e,\ldots,e) \mid \elet{y}{e}{\instr} \mid  \cmd;\cmd 
    \mid \elab{\assert{e = e}}{e} \mid \eqcast{\mx{e}{e}}{\notg{\phi}} & \gdesc{instructions}\\[1mm] %\pre{\eqs} \mid \post{\eqs} \\[1mm]
...
\newcommand{\peqfig}{
\begin{fpfig}[t]{Abstract constraints and their evaluation.}{fig-peq}
$$
  \begin{array}{rcl}
    \peq &::=& e \eop e \mid \notg{\eqs} \wedge \notg{\eqs} \mid \notg{\eqs} \vee \notg{\eqs}
  \mid \notg{\eqs} \impl \notg{\eqs} \mid \neg\eqs
...
\begin{mathpar}
  \inferrule
      ...
      {e_1 \bop e_2 \redx \phi_1 \bop \phi_2}
