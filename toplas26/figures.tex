...
\begin{mathpar}
  \inferrule[GenShares]
      {
        \genshares(\phi,\rx{y}{\cid}) = \phi_1,\phi_2 \\ 
        \eqs \models x_1 \eop \phi_1 \wedge x_2 \eop \phi_2  
      }
      {\eqs \vdash \Gamma,R \stredx \Gamma \cup \setit{[x_1,x_2] : \sharety}, R \uplus \setit{\rx{y}{\cid_1}}}
  ...
  \inferrule[SecOpen]
      ...
      {\eqs \vdash \Gamma,R \stredx \Gamma \cup \setit{\pubx{\recon(\px{x},\px{y})}  : \pubty}, R \uplus \setit{\rx{y}{\cid_{\oid}}}}

  \inferrule[Reveal]
      {
        \Gamma, \eqs \vdash [\px{x},\px{y}] : \sharety
      }
      {\eqs \vdash \Gamma,R \stredx \Gamma \cup \setit{\pubx{\recon(\px{x},\px{y})}  : \outty}, R}
...
\begin{array}{rcl@{\hspace{4mm}}r}
  ...
  \assign{e}{e} \mid f(e,\ldots,e) \mid \elet{y}{e}{\instr} \mid  \cmd;\cmd 
    \mid \elab{\assert{e = e}}{e} \mid \eqcast{\mx{e}{e}}{e} & \gdesc{instructions}\\[1mm] %\pre{\eqs} \mid \post{\eqs} \\[1mm]
...
\begin{mathpar}
  ...
  \inferrule
      {e_1 \redx \elab{\be_1}{\cid_1} \\ e_2 \redx \elab{\be_2}{\cid_2} }
      {e_1 \bop e_2 \redx \toeq{\elab{\be_1}{\cid_1}} \eop \toeq{\elab{\be_2}{\cid_2}}}
