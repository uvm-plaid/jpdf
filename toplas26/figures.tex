...
\begin{tabular}{r|c|c|c|c|c}
  \textit{SMT theory} & Bit-Vector & SMFF $\fieldp{2}$ & SMFF $\fieldp{2^{17} - 1}$ &  SMFF $\fieldp{2^{31} - 1}$ &
      SMFF $\fieldp{2^{61} - 1}$ \\
  \hline
  \text{Passive Beaver Library} & N/A & .476 & .48 & .466 & .644 \\
  \text{Malicious Beaver (BDOZ) Library} & N/A & .464 & .528 & .641 & .653\\
  \text{GMW Library} & N/A & .377 & N/A & N/A & N/A \\
  \text{GMW 2-Bit Zero Test (3 Gates)} & .927 & 363.01 & N/A & N/A & N/A \\
  \text{GMW 8-Bit Zero Test (15 Gates)} & 1.053 & Unknown & N/A & N/A & N/A \\
  \text{GMW 64-Bit Zero Test (127 Gates)} & 6.501 & Unknown & N/A & N/A & N/A 
\end{tabular}
\end{center}
\end{fpfig}
}
