...
\begin{mathpar}
  ...
  \inferrule[SecOpen]
      ...
      {\eqs \vdash \Gamma,R \stredx \Gamma \cup \setit{\pubx{\px{x} + \px{y}}  : \pubty}, R \uplus \setit{\rx{y}{\cid_{\oid}}}}
...
\begin{array}{rcl@{\hspace{4mm}}r}
  ...
  \tau &::=& \mathit{string} \mid \mathit{cid} \mid \{ \flab_1 : \tau_1; \ldots; \flab_n : \tau_n \} & \gdesc{basic types}\\[1mm]
...
\begin{array}{rclr}
  ...
  \sta &::=& e_1 \kwas e_2 \mid [e_1,e_2] : \sharety \mid \pubx{e} : \pubty \mid \pubx{e} : \outty
      & \qquad \textit{share type annotations} \\     
  \cmd &::=& \cdots \mid \sta
\end{array}
$$
...
\begin{fpfig}[t]{Typing rules for share type annotations.}{fig-shtripsta}
\begin{mathpar}
  \inferrule[Coerce]
      {e_1 \redx \phi_1 \\ e_2 \redx \phi_2}
