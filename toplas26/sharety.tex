...
$$
\begin{array}{rclr}
\sta &::=& [e,e] \kwas [\phi - \rx{e}{e}, \rx{e}{e}] \mid
(\mx{e}{e},\mx{e}{e}) : \sharety \mid & \quad \textit{type annotations} \\
& & (\px{e}{e},\px{e}{e}) : \pubty \mid [e] : \pubty \\
\cmd &::=& \cdots \mid \sta
\end{array}
...
\begin{mathpar}
  \inferrule[CoerceGenshare]
      ...
      {\shtrip{\Gamma_{\cid_1},\Gamma_{\cid_2}, R, \xdefs}
        {[e_1,e_2] \kwas [e_1',e_2']}
        {\Gamma_{\cid_1} \cup \setit{[\mx{w_1}{\cid_1},\mx{w_2}{\cid_2}] : \sharety},
          \Gamma_{\cid_2}, R \uplus \setit{\rx{w}{\cid}}, \xdefs} }
      
  \inferrule[CoerceSecureOpen]
      {e_1 \redx \px{x} \\ e_2 \redx \px{y} \\
        e_1' \redx \phi - \rx{w_3}{\oid} \\
        e_2' \redx \rx{w_3}{\oid}\\
        \Gamma \defeq \setit{\pubx{\px{x} + \px{y}} : \pubty}}
      {\shtrip{\Gamma_{\cid_1},\Gamma_{\cid_2}, R, \xdefs}
        {[e_1,e_2] \kwmask [e_1',e_2']}
        {\Gamma_{\cid_1} \cup \Gamma,
        \Gamma_{\cid_2} \cup \Gamma,
        R \uplus \setit{\rx{w}{\oid}}, \xdefs} }

  \inferrule[LocalShares]
      {e_1 \redx \px{w_1}{\cid_1} \\ e_2 \redx \mx{w_2}{\cid_2}  \\
        \Gamma_{\cid_1} \Vdash [\phi_1, \phi_2] : \sharety\\
        \Gamma_{\cid_2} \Vdash [\phi_2, \phi_1] : \sharety
      }
      {\shtrip{\Gamma_{\cid_1},\Gamma_{\cid_2}, R,
          \xdefs[\mx{w_1}{\cid_1} \mapsto \phi_1, \mx{w_2}{\cid_2} \mapsto \phi_2]}
        {(e_1,e_2) : \sharety}
        {\Gamma_{\cid_1} \cup \setit{[\mx{w_1}{\cid_1},\mx{w_2}{\cid_2}] : \sharety},
          \Gamma_{\cid_2} \cup \setit{[\mx{w_2}{\cid_2},\mx{w_1}{\cid_1}] : \sharety},
          R, \xdefs}}
\end{mathpar}
