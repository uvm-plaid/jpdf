...
\begin{lemma}
  Given $\eqspre \wedge \toeq{\prog},\Gamma,R  : {OK}$ and $\iov(\prog) = S \cup V \cup O$
  and $\eqspre \wedge \toeq{\prog},\Gamma,R \Gamma,R \stredx R',\Gamma'$.
  Then $\eqspre \wedge \toeq{\prog}, \Gamma',R' : {OK}$.
\end{lemma}
