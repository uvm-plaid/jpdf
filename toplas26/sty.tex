...
previous systems that only enforce a gradual release property
(\cite{skalka-near-esop25}). By connecting this analysis with
protocol correctness properties enforced by the Hoare logic
discussed in Section \ref{section-smt}, the output can also
be connected to an intended ideal functionality. 
