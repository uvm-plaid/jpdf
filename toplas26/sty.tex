...
consumed by $\genshares$, ensuring that it has not already been used. The
...
don't reveal more about secrets than their reconstruction does. Properties
(iii) and (iv) ensure that OTPs used for generating shares or for
...
verified in typing judgements, and by Definition \ref{def-genshares} and the
assumption of soundness of $\genshares$.
\begin{lemma}
...
and the security of share generation using OTPs-- that is, shares
