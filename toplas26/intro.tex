...
in Section 8. In addition, we develop an implementation capable of
...
the Goldreich-Micali-Wigderson (GMW), Ben-Or-Goldwasser-Widgerson (BGW),
and Bendlin-Damgard-Orland-Zakarias (BDOZ), and report related
performance metrics.
...
confidentiality type systems supporting analysis of more complex
programs that enforces passive security in the real/ideal model, vs.~a
weaker gradual release property as in \cite{skalka-near-esop25}.
