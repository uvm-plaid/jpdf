...
formulations of security with SMT verification to enforce correctness
and security properties of MPC protocols.
...
\item In Section~\ref{section-sty}, a novel share type system, enabling security verification for protocols that use secret sharing as a building block; our approach works for any secret sharing scheme and enforces noninterference modulo output.
\item In Section~\ref{section-ipj}, an integrity type system for extending semi-honest security to malicious security.
...
share type system presented in Section 5, and fully develops the
compositional type-based verification approach in Section 8. In
addition, we develop an implementation capable of automating the
verification of examples given in the prior work, and our extensions
in this work additionally enable the type-based verification of
noninterference modulo output for secret sharing protocols that
leverage Beaver triples (see Section~\ref{section-examples}).
