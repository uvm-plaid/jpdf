...
\begin{definition}
  Given $\pmf$ and $\store$ with $\rvs(\pmf) \ne \dom(\store)$,
  $\pmf(\store) \defeq \margd{\pmf}{\dom(\store) \cap \rvs(\pmf)}(\store_{\dom(\store) \cap \rvs(\pmf)})$.
...
%  \pmf(\{ x \mapsto 1\}\ |\ \{ y \mapsto 1 \}) = 1$.
  We write $\condsep{\pmf}{X_1}{X_2}{X_3}$ iff $\condd{\pmf}{X_2 \cup X_3}{X_1}
  = \condd{\pmf}{X_2}{X_1} * \condd{\pmf}{X_3}{X_1}$. If $X_1$ is empty
