...
(construction $\bv{\cdot}$, summation $\oplus$, and subtraction
$\ominus$). We note that bit vector operations are included \emph{only}
...
\begin{array}{rclr}
  \phi &::=& v \mid x \mid \phi \fplus \phi \mid \phi \fminus \phi \mid \phi \ftimes \phi
     \mid \bv{\phi_1,\ldots,\phi_n} \mid \phi \oplus \phi \mid \phi \ominus \phi & \textit{constraint terms}\\ 
