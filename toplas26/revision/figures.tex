...
\begin{fpfig}[t]{Average verification times for $\metaprot$ binary and arithmetic circuit libraries and small circuits over 20 trials, in seconds. Cells marked with * were limited to a single trial due to excessive verification times.}{fig-preludetest}
\begin{center}
\begin{tabular}{c}
...
\begin{tabular}{l|c|c|c}
  ...
  \hline
  \text{GMW 2-Bit Zero Test (3 Gates)} & Unknown & Unknown & 261.098 \\
  \text{GMW 2-Bit Addition (4 Gates)} & .038 & .032 & 261.098 \\
  \text{GMW 8-Bit Zero Test (15 Gates)} & .051 & .057 & Unknown \\
  \text{GMW 64-Bit Zero Test (127 Gates)} & 0.308 & 1.071 & Unknown \\
  \text{GMW 64-Bit Addition (376 Gates)} & 5.735 & 4623.666* & Unknown \\
  \text{GMW 64-Bit Subtraction (439 Gates)} & 9.985 & 10661.325* & Unknown \\
\end{tabular}
\end{tabular}
