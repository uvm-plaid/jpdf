...
poorly in all these circuits. We beleve the optimizations that make the
bit-vector solver efficient in these cases are unavilable to the SMFF solver,
even when it runs in in $\mathbb{F}_2$. In all but the simplest cases, it did
not finish.
