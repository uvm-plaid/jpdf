...
and $\aruns(\prog)$ is the analog in the malicious setting. It is
necessary to define $\aruns$ independently since adversaries can
rewrite their own protocol steps and thus affect protocol
semantics. Since we constrain programs to not overwrite any variable,
we are assured that final memories contain both a complete record of
all initial secrets as well as views resulting from communicated
information. This formulation will be fundamental to our consideration
of probability distributions and hyperproperties of protocols.
%In this
