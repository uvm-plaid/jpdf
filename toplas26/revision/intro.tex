...
checking.  Thus $\metaprot$ program analysis automates security and
correctness properties of the low-level $\minicat$ protocols that
$\metaprot$ programs evaluate to.
