...
There are several directions for future work on 


 - Generalize from F2 to Fp?
 - Better methods for modularization.
 - Incorporate non-information theoretic elements, e.g., sym keys for YGC.
 - Parallelism and commits.
 - Swanky.
