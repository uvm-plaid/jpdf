...
allow standard homomorphic encryption operations, and in particular ensure
...
\begin{theorem}[Confidentiality Type Soundness]
...
evaluation. To make rules a little more succinct we define ``evaluating
