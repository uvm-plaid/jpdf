...
\begin{definition}
  ...
  \item $\begin{array}[t]{l}\forall \store_1, \store_2 \in \mems(S_H), \store \in \mems(\cinputs)\ . \\
    ...
    \qquad \implies\\
    \quad \progtt(\prog,\adversary)(\houtputs|\store_1 \cup \store) = \progtt(\prog,\adversary)(\houtputs|\store_2 \cup \store)\end{array}$
  \end{enumerate}
\end{definition}
...
\begin{definition}
  ...
  we have:
  $$
   \progtt(\prog,\adversary_1)(\houtputs|\store) = \progtt(\prog,\adversary_2)(\houtputs|\store)
  $$
\end{definition}
...
\begin{lemma}
  ...
  \progtt(\prog,\adversary_1)(\houtputs|\store \cup \store^1_{\cinputs}) =
  \progtt(\prog,\adversary_2)(\houtputs|\store \cup \store^2_{\cinputs})
  %\end{array}
  $$
\end{lemma}
