...
concepts and advantages of our methods.
...
\begin{example}[$\lambda_{\mathrm{obliv}}$]
  ...
  examples shows that reuse of coin flips can result in release of
  ...
  more likely to be 1 in case $\view{0}{0}$ is 1:
  \begin{verbatimtab}
...
following:
\begin{verbatimtab}  
  view[2, mc] := OT(s[2, c], s[1, m1], s[1, m0])
\end{verbatimtab}
\end{example}
