...
composable program units. \cnote{Cur the following example to save
  space?.}  As a simple example, consider 3 party secret sharing as
...
\begin{fpfig}{Yao's Garbled Circuit component functions.}{fig-ygc-lib}
{\footnotesize
\begin{verbatimtab}
