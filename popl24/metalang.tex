...
\cite{XXX}. Some consequences of safety errors, for example accidental
...
implementation, we adapt \emph{synthesis} as defined in MetaML \cite{XXX}
...
\tjudge{\viewst_1}{\Gamma}{e_2}{\stringty{e_2'}}{\viewst_2}}
{\tjudge{\viewst}{\Gamma}{\secret{e_1}{e_2}}{\bet{e_1'}}}
...
Our $\metaprot$ type safety result is as follows. In addition to safe execution of the metaprogram,
it also guarantees safety of the residual $\fedprot$ program. 
