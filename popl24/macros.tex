...
\newcommand{\minifed}{\mathit{fedprot}}
\newcommand{\minicat}{\minifed}
\newcommand{\fedprot}{\minifed}
\newcommand{\metaprot}{\mathit{metaprot}}
...
\long\def\cnote#1{{\small\textbf{\textit{\color{brown}(*#1 -- Chris*)}}}}
\long\def\mnote#1{{\small\textbf{\textit{\color{blue}(*#1 -- Michael*)}}}}
\long\def\dnote#1{{\small\textbf{\textit{\color{violet}(*#1 -- David*)}}}}
