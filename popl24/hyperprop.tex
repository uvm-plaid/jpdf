...
\begin{mathpar}
X \defeq \{ \vx{0}{0}, \sx{1}{0} \}
  
\pdf{X} \defeq \margd{\progd(\prog_3)}{X}
\end{mathpar}
...
\begin{mathpar}
  \condd{(\pdf{X}}{\{ \vx{0}{0} \mto 0\})}(\{ \sx{1}{0} \mapsto 0\}) = .5
  
  \condd{(\pdf{X}}{\{ \vx{0}{0} \mto 0\})}(\{ \sx{1}{0} \mapsto 1\}) = .5
  
  \condd{(\pdf{X}}{\{ \vx{0}{0} \mto 1\})}(\{ \sx{1}{0} \mapsto 0\}) = .5

  \condd{(\pdf{X}}{\{ \vx{0}{0} \mto 1\})}(\{ \sx{1}{0} \mapsto 1\}) = .5
\end{mathpar}
...
correctness. 
\begin{mathpar}
  \condd{(\pdf{X}}{\{ \vx{0}{0} \mto 0\})}(\{ \sx{1}{0} \mapsto 0\}) = 1
  
  \condd{(\pdf{X}}{\{ \vx{0}{0} \mto 0\})}(\{ \sx{1}{0} \mapsto 1\}) = 0
  
  \condd{(\pdf{X}}{\{ \vx{0}{0} \mto 1\})}(\{ \sx{1}{0} \mapsto 0\}) = 0

  \condd{(\pdf{X}}{\{ \vx{0}{0} \mto 1\})}(\{ \sx{1}{0} \mapsto 1\}) = 1
\end{mathpar}
...
\example{Example: Additive Secret Sharing} A nice ``Hello World''
