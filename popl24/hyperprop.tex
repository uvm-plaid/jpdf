...
compositional properties that can be verified in a scalable manner for
protocols that incorporate modular sub-protocols, with a
specific use-case of Yao's Garbled Circuits (YGC) as an example.
The latter methodology demonstrates a particular advantage of our
