...
\begin{definition}
  ...
  for all $H,C$ the judgement $\ipj{\initigamma(\eqspre)}{\eqs}{\prog}{\Gamma}$ is valid
...
\begin{mathpar}
  \inferrule[Mesg]
            {e_1 \redx x \\ e_2 \redx \be \\ e_3 \redx \cid \\ \atj{R_1}{\toeq{\elab{\be}{\cid}}}{R_2}{\ty}}
            {\mtj{R_1}{\xassign{e_1}{e_2}{e_3}}{\eqs}{x:\ty}{R_1;R_2}{\eqs \wedge x \eop \toeq{\elab{\be}{\cid}}}}

  \inferrule[Encode]
            {e_1 \redx w \\ e_2 \redx \cid \\ e_3 \redx \phi \\
              \eqs \models \toeq{\elab{\be}{\cid}} \eop \phi\\
              \atj{R_1}{\phi}{R_2}{\ty}}
            {\mtj{R_1}{\eqcast{\mx{e_1}{e_2}}{e_3}}{\eqs}{\mx{w}{\cid}:\ty}{R_1;R_2}{E\wedge \mx{w}{i} \eop \phi}}

  \inferrule[App]
            {\tsig(f) = \dht{y_1,\ldots,y_n}{\notg{\eqs_1}}{\notg{\Gamma}}{\notg{R}}{\notg{\eqs_2}} \\
              e_1 \redx \mv_1\ \cdots\ e_n \redx \mv_n \\
              \subn = [\mv_1/y_1]\cdots[\mv_n/y_n] \\
              \subn(\hty{\notg{\eqs_1}}{\notg{\Gamma}}{\notg{R}}{\notg{\eqs_2}}) \redx \hty{\eqs_1}{\Gamma}{R}{\eqs_2} \\
              \eqs \models \eqs_1}
            {\mtj{R_1}{f(e_1,\ldots,e_n)}{\eqs}{\Gamma}{R_1;R}{\eqs \wedge \eqs_2}}
...
\begin{mathpar}
  \inferrule[Sig]
            {\codebase(f) = y_1,\ldots,y_n, \instr \\
              \subn = [\mv_1/y_1]\cdots[\mv_n/y_n] \\
              \subn(\hty{\notg{\eqs_1}}{\notg{\Gamma}}{\notg{R}}{\notg{\eqs_2}}) \redx \hty{\eqs_1}{\Gamma}{R}{\eqs_2} \\
              \mtj{\varnothing}{\subn(\instr)}{\eqs_1}{\Gamma}{R}{\eqs} \\
              \eqs \models \eqs_2}
            {f : \dht{y_1,\ldots,y_n}{\notg{\eqs_1}}{\notg{\Gamma}}{\notg{R}}{\notg{\eqs_2}}}
\end{mathpar}
...
\begin{theorem}
  ...
  \item $\ipj{\initigamma(\eqspre)}{\eqs}{\prog}{\Gamma}$ is valid.
  \end{enumerate}
\end{theorem}
