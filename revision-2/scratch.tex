...
\begin{mathpar}
  \inferrule[Send]
            {\tj{\Gamma}{R}{\eqs}{\cid}{\be}{\lty{\ty}{\latel}}}
            {\ej{\Gamma}{R}{\eqs}{\xassign{x}{\be}{\cid}}{\Gamma; x : \lty{\ty}{\latel}}
  ...
  \inferrule[Constraint]
      {\ej{\Gamma_1}{R}{\eqs_1}{\prog}{\Gamma_2}{\eqs_2} \\ \eqs_1' \models \eqs' \\ \eqs_2 \models \eqs_2'}
      {\ej{\Gamma_1}{R}{\eqs_1'}{\prog}{\Gamma_2}{\eqs_2'}}
\end{mathpar}

\section{$\metalang$ Syntax and Semantics}
