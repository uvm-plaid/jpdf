...
\begin{array}{rcl@{\hspace{2mm}}r}
  ...
  \ity &::=& \latel \mid \cid \mid \ity \prejoin \ity \\
  \Gamma &::=& \varnothing \mid \Gamma; x : \ity
\end{array} 
$$
...
\begin{mathpar}
  ...
  \inferrule[Secret]
  {}
  {\itj{\Gamma}{\eqs}{\cid}{\secret{w}}{\cid}}
  
  \inferrule[Rando]
  {}
  {\itj{\Gamma}{\eqs}{\cid}{\flip{w}}{\cid}}
  ...
  \inferrule[Binop]
  {\itj{\Gamma}{\eqs}{\cid}{\be_1}{\ity_1} \\
   \itj{\Gamma}{\eqs}{\cid}{\be_2}{\ity_2} \\ \oplus \in \{ \fplus,\fminus,\ftimes \}}
  {\itj{\Gamma}{\eqs}{\cid}{\be_1 \oplus \be_2}{\ity_1 \prejoin \ity_2}}
%
...
\begin{mathpar}
  \inferrule[Send]
            ...
            {\ipj{\Gamma}{\eqs}{\xassign{x}{\be}{\cid}}{\Gamma; x : \cid \prejoin \ity}}
...
%            
  ...
  \inferrule[MAC]
            ...
            {\ipj{\Gamma}{\eqs}{\elab{\assert{\macbdoz{w}}}{\cid}}{\Gamma; \mx{w\ttt{s}}{\cid}: \cid}}
%
%  \inferrule[MAC]
%            {\eqs \models 
...
\begin{mathpar}
  ...
  \icod{\ity_1 \prejoin \ity_2}{H,C} = \icod{\ity_1}{H,C} \wedge \icod{\ity_2}{H,C}
\end{mathpar}  
