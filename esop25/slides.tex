...
\begin{frame}{Using Satisfiability Modulo Finite Fields (SMFF)}

  SMFF supports equational constraint definitions $\eqs$ over a finite field $\mathcal{F}_{p}$
  with a mature solver, in the style of SMT.
...
$$
\begin{array}{c}
  \toeq{\prog} \wedge \ttt{out} \eop \mx{ss1}{1} + \mx{ss1}{2} + \mx{ss1}{3}\\ \models\\
