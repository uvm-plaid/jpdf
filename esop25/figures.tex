\newcommand{\compwrapfig}
{
  \begin{wrapfigure}{r}{0cm}
    \begin{tabular}{lccccccc}
      ...
      $\metaprot$/$\minifed$ \cite{skalka-near-ppdp24} & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark\\
      \hline
    \end{tabular}
    \caption{Comparison of systems for verification of MPC security in PLs.}
    \label{fig-comp-wrap}
  \end{wrapfigure}
}
