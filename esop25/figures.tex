...
\begin{array}{rcl@{\hspace{2mm}}r}
  ...
  \assign{e}{e} \mid \elab{\assert{e = e}}{e} \mid f(e,\ldots,e) \mid  \cmd;\cmd  & \gdesc{instructions}\\[1mm] %\pre{\eqs} \mid \post{\eqs} \\[1mm]
...
\begin{mathpar}
  ...
  \inferrule
      {\codebase(f) = y_1,\ldots,y_n, \instr \\e_1 \redx \mv_1 \ \cdots \ e_n \redx \mv_n \\
        \subn = [\mv_1/y_1]\cdots[\mv_n/y_n] \\ \subn(\instr) \redx \prog
      }
