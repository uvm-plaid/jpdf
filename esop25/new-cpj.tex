...
\section{New Confidentiality Typing}
...
\begin{mathpar}
  ...
  \inferrule[Rand]
            {}
            {\Gamma, \varnothing, \eqs \vdash \rx{w}{\cid} : \unity{\rx{w}{\cid}}{\setit{\rx{w}{\cid}}}}
  ...
  \inferrule[Enc]
            ...
            {\Gamma, R;\rx{w}{\cid}, \eqs \vdash \phi \fminus \rx{w}{\cid} : \unity{\rx{w}{\cid}}{\ty}}
