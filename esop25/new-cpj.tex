...
\begin{mathpar}
  ...
  \inferrule[Rand]
            {}
            {\Gamma, \varnothing, \eqs \vdash \rx{w}{\cid} : \unity{\rx{w}{\cid}}}
  ...
  \inferrule[Enc]
            {}
            {\Gamma, R;\rx{w}{\cid}, \eqs \vdash \phi \fminus \rx{w}{\cid} : \unity{\rx{w}{\cid}}}

  \inferrule[HEAdd]
      {\Gamma, R_1, \eqs \vdash \phi_1 : \setit{\unity{\rkey_1}} \\
        \Gamma, R_2, \eqs \vdash \phi_2 : \setit{\unity{\rkey_2}} \\
        \uncorr{\rkey_1}{\rkey_2}
      }
      {\Gamma, R_1;R_2, \eqs \vdash \phi_1 \fplus \phi_2 : \setit{\unity{\rkey_1 \oplus \rkey_2}}}
