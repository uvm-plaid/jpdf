  ...
  \inferrule[Sharing]
      {
        ...
        \\
        \exists R\ .\ (\forall M \in \pow(\mx{w_1}{\cid_1},\ldots,\mx{w_n}{\cid_n})\ .\ |M| < n \implies \\
 ...
 \inferrule[Secure Opening]
      {
        ...
        \Gamma,R,\eqs \vdash \phi : \unity{R}{\eset}
      }
      {
        \Gamma, R, \eqs \vdash \cvec{\px{w_1},\ldots,\px{w_n}} : \secopent
      }
