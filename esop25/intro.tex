...
manual. Somewhat independently, a significant body of work in
programming languages has focused on definition and enforcement of
confidentiality and integrity \emph{hyperproperties}
\cite{10.5555/1891823.1891830} such as noninterference and gradual
release \cite{4223226,sabelfeld2009declassification}. Following a
tradition of connecting cryptographic and PL-based security models
...
hyperproperties for our model with familiar information flow analogs,
and to show how these properties can be leveraged for improved proof
automation.
