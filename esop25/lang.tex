...
\end{definition}
An example of a $\minicat$ protocol, for additive secret
sharing, is discussed in Section \ref{section-smt-toeq}.
...
preprocessed memory (a memory that satsfies a predicate
$\preproc$), and $\aruns(\prog)$ is the analog in the malicious
setting. This formulation will be fundamental to our consideration
